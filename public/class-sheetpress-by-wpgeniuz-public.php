 ...
 * @subpackage Sheetpress_By_Wpgeniuz/public
 */
 ...
 */
class Sheetpress_By_Wpgeniuz_Public {
	...
	public function sheetpress_enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/sheetpress-by-wpgeniuz-public.css', array(), $this->version, 'all' );
	...
	public function sheetpress_enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/sheetpress-by-wpgeniuz-public.js', array( 'jquery' ), $this->version, false );
